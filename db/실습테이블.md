...
erDiagram
    ...
    DEPARTMENTS ||--o{ EMPLOYEES : "소속직원"

    DEPARTMENTS ||--o{ JOB_HISTORY : "변경기록"
    EMPLOYEES ||--o{ JOB_HISTORY : "변경기록"
    JOBS ||--o{ JOB_HISTORY : "변경기록"
     
    JOBS ||--o{ EMPLOYEES : "담당직원"
    EMPLOYEES ||--o{ EMPLOYEES : "관리자"

    REGIONS ||--o{ COUNTRIES : "소속국가"
    COUNTRIES ||--o{ LOCATIONS : "소속소재지"
    LOCATIONS ||--o{ DEPARTMENTS : "소속부서"
